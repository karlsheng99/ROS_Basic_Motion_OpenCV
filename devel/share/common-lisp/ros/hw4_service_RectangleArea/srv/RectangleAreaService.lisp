...
(cl:in-package hw4_service_RectangleArea-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <RectangleAreaService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RectangleAreaService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hw4_service_RectangleArea-srv:<RectangleAreaService-request> is deprecated: use hw4_service_RectangleArea-srv:RectangleAreaService-request instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <RectangleAreaService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hw4_service_RectangleArea-srv:width-val is deprecated.  Use hw4_service_RectangleArea-srv:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <RectangleAreaService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hw4_service_RectangleArea-srv:height-val is deprecated.  Use hw4_service_RectangleArea-srv:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RectangleAreaService-request>)))
  ...
  "hw4_service_RectangleArea/RectangleAreaServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RectangleAreaService-request)))
  "Returns string type for a service object of type 'RectangleAreaService-request"
  "hw4_service_RectangleArea/RectangleAreaServiceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RectangleAreaService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RectangleAreaService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hw4_service_RectangleArea-srv:<RectangleAreaService-response> is deprecated: use hw4_service_RectangleArea-srv:RectangleAreaService-response instead.")))

(cl:ensure-generic-function 'area-val :lambda-list '(m))
(cl:defmethod area-val ((m <RectangleAreaService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hw4_service_RectangleArea-srv:area-val is deprecated.  Use hw4_service_RectangleArea-srv:area instead.")
  (area m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RectangleAreaService-response>)))
  ...
  "hw4_service_RectangleArea/RectangleAreaServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RectangleAreaService-response)))
  "Returns string type for a service object of type 'RectangleAreaService-response"
  "hw4_service_RectangleArea/RectangleAreaServiceResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RectangleAreaService)))
  ...
  "hw4_service_RectangleArea/RectangleAreaService")