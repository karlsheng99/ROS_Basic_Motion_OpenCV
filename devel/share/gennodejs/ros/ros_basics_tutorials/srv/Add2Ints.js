...
// (in-package ros_basics_tutorials.srv)
...
class Add2IntsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Add2IntsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Add2IntsRequest
    let len;
    let data = new Add2IntsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Add2IntsRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class Add2IntsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Add2IntsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Add2IntsResponse
    let len;
    let data = new Add2IntsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new Add2IntsResponse(null);
...
module.exports = {
  ...
  datatype() { return 'ros_basics_tutorials/Add2Ints'; }
};
